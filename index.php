...
<body>
    ...
    <!-- banner bottom shape -->
    <!-- <section class="w3l-clients py-sm-5 py-4" id="clients">
        <div class="call-w3">
            <div class="container">
    ...
    <!-- <section class="w3l-bottom-grids-6 py-5" id="features">
        <div class="container py-lg-5 py-md-4">
            <div class="text-center">
                ...
                <h3 class="title-big mb-sm-5 mb-4 pb-sm-0 pb-2">The services of the company include </h3>
            </div>
            <div class="grids-area-hny main-cont-wthree-fea row custm-index">
                ...
                <div class="col-lg-4 col-md-6 grids-feature mt-sm-0 mt-4">
                    <div class="area-box">
                        <h4><a href="#feature" class="title-head">Web & Mobile Application Development and Hosting </a></h4>
            ...
            <div class="container py-lg-5 py-md-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4 align-self">
                        ...
                        <p class="mt-md-4 mt-3">Passion has a motivating factor; therefore, it is a significant need for high quality learning and teaching. Passion is seeking for the new, and experiencing new ideas. Passion is on the basis of effective teaching.</p>
            ...
            <div class="container py-lg-5 py-md-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4">
                        ...
                        <p class="mt-md-4 mt-3">Website stays ahead of the curve with digital marketing trends. Our success has us leading the pack amongst our competitors with our ability to anticipate change and innovation. </p>
