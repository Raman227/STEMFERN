<?php 
    ...
    try{
		$featureData = $db->query("select * from  contact_form")->fetchAll();
        ...
        <section class="w3l-breadcrumb">
            <div class="container">
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span> All Contacts</li>
                </ul>
            </div>
        </section>
    </div>
            ...
            <div class="container">
                <div class="d-grid">
                    <div class="map-content-9">
                        <h5 class="mb-sm-4 mb-3">All Contacts</h5>
  ...
  <tbody>        
           <?php
					foreach($featureData as $feature){
                        ...
                        <td><a class='delLink' href=remove_message.php?id=".$feature['id'].">Delete</a></td>
